...
def main():
    ...
    # check_arquivo_massivo_test_qa(connection)
    # import_update_itens_integracao(connection)
    # import_new_gitlab_itens(connection)
    # diff_sharepoint_x_gitlab_itens(connection)
    # diff_gitlab_x_sharepoint_itens(connection)
    # diff_sharepoint_x_meg_itens(connection)
    # diff_meg_x_sharepoint_itens(connection)
    # import_update_gitlab_itens_oss(connection)
